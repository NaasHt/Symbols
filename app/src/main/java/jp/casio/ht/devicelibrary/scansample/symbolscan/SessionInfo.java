...
public class SessionInfo {
    ...
    public static String userName = "In"//Inkl
            ;
    ...
    public static double getStockTotalAmount(String barcode) {
        List<StockRecord> stockList = getStock().get(barcode);
        if(stockList == null || stockList.isEmpty()) {
            return 0;
        } else {
            return stockList.stream().mapToDouble(StockRecord::getQuantity).sum();
        }
    }
